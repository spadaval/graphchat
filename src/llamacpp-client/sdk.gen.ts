...
import type {
  ...
  PostApplyTemplateResponses,
  PostCompletionData,
  PostCompletionErrors,
  PostCompletionResponses,
  PostDetokenizeData,
  PostDetokenizeResponses,
  PostEmbeddingsData,
  PostEmbeddingsResponses,
  PostInfillData,
  PostInfillResponses,
  PostLoraAdaptersData,
  PostLoraAdaptersResponses,
  PostPropsData,
  PostPropsErrors,
  PostPropsResponses,
  PostRerankingData,
  PostRerankingResponses,
  PostSlotsByIdSlotData,
  PostSlotsByIdSlotErrors,
  PostSlotsByIdSlotResponses,
  PostTokenizeData,
...
import {
  ...
  zGetSlotsResponse,
  zGetV1ModelsData,
  zGetV1ModelsResponse,
  zPostApplyTemplateData,
  zPostApplyTemplateResponse,
  zPostCompletionData,
  zPostCompletionResponse,
  zPostDetokenizeData,
  zPostDetokenizeResponse,
  zPostEmbeddingsData,
  zPostEmbeddingsResponse,
  zPostInfillData,
  zPostInfillResponse,
  zPostLoraAdaptersData,
  zPostPropsData,
  zPostRerankingData,
  zPostRerankingResponse,
  zPostSlotsByIdSlotData,
  zPostSlotsByIdSlotResponse,
  zPostTokenizeData,
  zPostTokenizeResponse,
  zPostV1ChatCompletionsData,
  zPostV1ChatCompletionsResponse,
  zPostV1EmbeddingsData,
  zPostV1EmbeddingsResponse,
} from "./zod.gen";
 ...
 */
export const getProps = <ThrowOnError extends boolean = false>(
  options?: Options<GetPropsData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).get<
    GetPropsResponses,
    unknown,
 ...
 */
export const postProps = <ThrowOnError extends boolean = false>(
  options: Options<PostPropsData, ThrowOnError>,
) => {
 ...
 */
export const getSlots = <ThrowOnError extends boolean = false>(
  options?: Options<GetSlotsData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).get<
    GetSlotsResponses,
    GetSlotsErrors,
 ...
 * Manage slot actions
 */
export const postSlotsByIdSlot = <ThrowOnError extends boolean = false>(
  options: Options<PostSlotsByIdSlotData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    PostSlotsByIdSlotResponses,
    PostSlotsByIdSlotErrors,
 ...
 */
export const postEmbeddings = <ThrowOnError extends boolean = false>(
  options: Options<PostEmbeddingsData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    PostEmbeddingsResponses,
    unknown,
 ...
 */
export const postReranking = <ThrowOnError extends boolean = false>(
  options: Options<PostRerankingData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    PostRerankingResponses,
    unknown,
 ...
 * For code infilling
 */
export const postInfill = <ThrowOnError extends boolean = false>(
  options: Options<PostInfillData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    PostInfillResponses,
    unknown,
 ...
 */
export const postDetokenize = <ThrowOnError extends boolean = false>(
  options: Options<PostDetokenizeData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    PostDetokenizeResponses,
    unknown,
 ...
 */
export const postApplyTemplate = <ThrowOnError extends boolean = false>(
  options: Options<PostApplyTemplateData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    PostApplyTemplateResponses,
    unknown,
 ...
 */
export const getLoraAdapters = <ThrowOnError extends boolean = false>(
  options?: Options<GetLoraAdaptersData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).get<
    GetLoraAdaptersResponses,
    unknown,
 ...
 */
export const postLoraAdapters = <ThrowOnError extends boolean = false>(
  options: Options<PostLoraAdaptersData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    PostLoraAdaptersResponses,
    unknown,
