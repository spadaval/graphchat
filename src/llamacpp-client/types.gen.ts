...
export type PostSlotsByIdSlotError =
  PostSlotsByIdSlotErrors[keyof PostSlotsByIdSlotErrors];
...
export type PostSlotsByIdSlotResponse =
  PostSlotsByIdSlotResponses[keyof PostSlotsByIdSlotResponses];
...
export type PostEmbeddingsResponse =
  PostEmbeddingsResponses[keyof PostEmbeddingsResponses];
...
export type PostRerankingResponse =
  PostRerankingResponses[keyof PostRerankingResponses];
...
export type PostDetokenizeResponse =
  PostDetokenizeResponses[keyof PostDetokenizeResponses];
...
export type PostApplyTemplateResponse =
  PostApplyTemplateResponses[keyof PostApplyTemplateResponses];
...
export type GetLoraAdaptersResponse =
  GetLoraAdaptersResponses[keyof GetLoraAdaptersResponses];
