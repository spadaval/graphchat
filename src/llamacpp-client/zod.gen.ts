...
export const zPropsResponse = z.object({
  default_generation_settings: z.optional(
    z.object({
      id: z.optional(z.int()),
...
export const zPostSlotsByIdSlotData = z.object({
  ...
  query: z.object({
    action: z.enum(["save", "restore", "erase"]),
  }),
});
...
export const zPostCompletionResponse = z.object({
  ...
  prompt: z.optional(z.string()),
  stop_type: z.optional(z.enum(["none", "eos", "limit", "word"])),
  stopping_word: z.optional(z.string()),
  generation_settings: z.optional(
    z.object({
      n_predict: z.optional(z.int()),
      seed: z.optional(z.int()),
      temperature: z.optional(z.number()),
  ...
  completion_probabilities: z.optional(
    z.array(
      z.object({
        id: z.optional(z.int()),
  ...
  z.object({
    tokens: z.optional(
      z.array(
        z.object({
          id: z.optional(z.int()),
          piece: z.optional(z.union([z.string(), z.array(z.int())])),
        }),
      ),
    ),
  }),
 ...
 * Successful response
 */
export const zPostEmbeddingsResponse = z.array(
  z.object({
    index: z.optional(z.int()),
    embedding: z.optional(
 ...
 * Successful response
 */
export const zPostRerankingResponse = z.array(
  z.object({
    index: z.optional(z.int()),
 ...
 * Successful response
 */
export const zGetLoraAdaptersResponse = z.array(
  z.object({
    id: z.optional(z.int()),
...
export const zPostV1ChatCompletionsData = z.object({
  body: z.object({
    ...
    stream: z.optional(z.boolean()).default(false),
    stop: z.optional(z.union([z.string(), z.array(z.string())])),
